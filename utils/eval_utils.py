...
"""
post_improve_3d.py from WeakM3D
"""
...
if __name__ == '__main__':
    ...
    for i in range(50):
        det_dir = '/private/pengliang/WeakM3D_official/pred/Resnet34_b16_{}/data'.format(i)
        eval_from_scrach(gt_dir, det_dir, ap_mode=11)
